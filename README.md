...
# 💻 Tech Stack:
![My Skills](https://skillicons.dev/icons?i=java,py,html,css,cpp,js,flask,nodejs,expressjs,tailwindcss,react,vite,mongodb,supabase,markdown,regex,github,git,azure,googlecloud,firebase,vercel,netlify,figma,ps,pr,matlab,notion,postman)
