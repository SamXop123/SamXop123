...
# 💻 Tech Stack:
![My Skills](https://skillicons.dev/icons?i=java,py,html,css,cpp,js,flask,nodejs,expressjs,tailwindcss,markdown,regex,github,googlecloud,windows,vscode,pycharm,clion,vercel,netlify,figma,ps,pr,matlab,notion,postman)
